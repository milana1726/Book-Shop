const order = {
    ...
    orderChecked() {
        ...
        let output = '';
            ...
            <p class="text" >The delivery address is <u>${localStorage.getItem('street')}</u> street 
                house <u>${localStorage.getItem('house_number')}</u> flat <u>${localStorage.getItem('flat_number')}</u>.</p>
            <p class="text">Customer <u>${localStorage.getItem('customer_name')} ${localStorage.getItem('customer_surname')}</u>.</p>
